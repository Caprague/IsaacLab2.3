...
@configclass
class RslRlPpoActorCriticCfgAttention:
    """Configuration for the PPO actor-critic networks."""

    class_name: str = "ActorCriticAttention"
    """The policy class name. Default is ActorCriticAttention."""
    ...
    basic_obs_normalization: bool = MISSING
    """Whether to normalize the observation for the proprioception observations."""

    scan_obs_normalization: bool = MISSING
    """Whether to normalize the observation for the scan observations."""
    ...
    # Scan 尺寸(长x宽点数)
    scan_size_x: int = MISSING
    """The size of the scan in the x-direction."""
    scan_size_y: int = MISSING
    """The size of the scan in the y-direction."""

    mha_embed_dim: int = MISSING
    """The dimension of each head in the multi-head attention module."""
    mha_num_heads: int = MISSING
    """The number of heads in the multi-head attention module."""
    mha_dropout: float = MISSING
    """The dropout probability for the multi-head attention module."""

    basic_obs_dims_list: list[int] = MISSING
    """The dimensions of the basic observations."""
    basic_obs_history_length: int = MISSING
    """The length of the history for the basic observations."""
...
@configclass
class RslRlPpoAlgorithmCfgAttention:
    """Configuration for the PPO algorithm."""

    class_name: str = "PPOAttention"
    """The algorithm class name. Default is PPOAttention."""
...
@configclass
class RslRlBaseRunnerCfgAttention:
...
@configclass
class RslRlOnPolicyRunnerCfgAttention(RslRlBaseRunnerCfgAttention):
    """Configuration of the runner for on-policy algorithms."""

    class_name: str = "OnPolicyRunnerAttention"
    """The runner class name. Default is OnPolicyRunnerAttention."""

    policy: RslRlPpoActorCriticCfgAttention = MISSING
    """The policy configuration."""

    algorithm: RslRlPpoAlgorithmCfgAttention = MISSING
