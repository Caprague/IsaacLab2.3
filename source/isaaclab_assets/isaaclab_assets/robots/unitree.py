...
* :obj:`UNITREE_GO2_SELF_COLIISIONS_CFG`: Unitree Go2 robot with DC motor model for the legs, enabled self collisions
...
USD_PATHS = {
    "local": {
        "go2_mid360": "/home/robot/Isaac/Assets5.1/Assets/Isaac/5.1/Isaac/Robots/Unitree/Go2/Go2HeadMid360/go2_orin_nx_mid360.usd",
...
UNITREE_GO2_SELF_COLIISIONS_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{ISAACLAB_NUCLEUS_DIR}/Robots/Unitree/Go2/go2.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
