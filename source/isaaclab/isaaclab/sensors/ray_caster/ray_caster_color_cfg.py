...
from isaaclab.markers.config import RAY_CASTER_ATTENTION_MARKER_CFG
...
@configclass
class RayCasterColorCfg(SensorBaseCfg):
    """Configuration for the ray-cast sensor with color visualization."""
    ...
    class_type: type = RayCasterColor
    ...
    * ``world`` if rays' starting positions and directions are always fixed. This is useful in combination with a mapping
    ...
    visualizer_cfg: VisualizationMarkersCfg = RAY_CASTER_ATTENTION_MARKER_CFG.replace(prim_path="/Visuals/RayCasterColor")
    """The configuration object for the visualization markers. Defaults to RAY_CASTER_ATTENTION_MARKER_CFG.
