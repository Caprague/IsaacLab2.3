...
class RayCasterColor(SensorBase):
    """A ray-casting sensor with color visualization.
    ...
    cfg: RayCasterColorCfg
    """The configuration parameters."""

    def __init__(self, cfg: RayCasterColorCfg):
        ...
        self._ray_point_marker_indices = torch.Tensor([])
    ...
    def _initialize_rays_impl(self):
        ...
        self._ray_point_marker_indices = torch.zeros(self._view.count, dtype=torch.int16, device=self._device)
    ...
    def _debug_vis_callback(self, event):
        ...
        self.ray_visualizer.visualize(translations=viz_points, marker_indices=self._ray_point_marker_indices)

    def _set_vis_attention(self, attention: torch.Tensor):
        self._ray_point_marker_indices = attention.clone()
