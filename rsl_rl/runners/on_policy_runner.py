...
from rsl_rl.modules import ActorCritic, ActorCriticRecurrent, ActorCriticDepthImage, resolve_rnd_config, resolve_symmetry_config
...
class OnPolicyRunner:
    ...
    def _construct_algorithm(self, obs: TensorDict) -> PPO:
        ...
        actor_critic: ActorCritic | ActorCriticRecurrent | ActorCriticDepthImage = actor_critic_class(
